...
utils.defineProperty(HDNode, 'RNFromMnemonic', function(mnemonic){
  ...
  return new Promise(function(resolve, reject){
      ...
      if (!password) {
          ...
          for (var i = 0; i < password.length; i++) {
              ...
              if (c < 32 || c > 127) { reject('passwords with non-ASCII characters not supported in this environment'); }
          }
      }
...
module.exports = {
    ...
    RNFromMnemonic: HDNode.RNFromMnemonic,
